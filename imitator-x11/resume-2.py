...
ogrenme_dosyası = input("Klonlamayı yaptığınız mesajların olduğu dosyayı giriniz:")
with open(ogrenme_dosyası, 'r', encoding='utf-8') as f:
...
with open('max_sequence_len.txt', 'r') as file:
    max_sequence_len = int(file.read().strip())
...
model_ismi = input("Model ismini ve uzantısını giriniz:")
