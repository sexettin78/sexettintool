import os
os.system("figlet Metfora")
print('''
Yaptığınız ve yapacağınız herşeyden siz sorumlusunuz,hiçbir şekilde sorumluluk kabul edilmez.
...
''')
	...
	os.system("clear")
	os.system("python3 sexettintoolsv5.py")
elif(metfora=="3"):
	print('''
